...
double MLEcontour::get_par_hat() {
	double value = arma::as_scalar(par_hat(1));
	return value;
}

	// Exported Functions
SEXP testMLLx(SEXP arg1, SEXP arg2, SEXP arg3, SEXP arg4, SEXP arg5, SEXP arg6) {
...
SEXP testContourPt(SEXP arg1, SEXP arg2, SEXP arg3, SEXP arg4, SEXP arg5, SEXP arg6, SEXP arg7) {
	arma::colvec par=Rcpp::as<arma::colvec>(arg2);
	int dist_num=Rcpp::as<int>(arg3);
	double MLLx = Rcpp::as<double>(arg4);
	double RatioLL = Rcpp::as<double>(arg5);
	double RadLimit = Rcpp::as<double>(arg6);
	MLEcontour mycontour(arg1, par, dist_num, MLLx, RatioLL, RadLimit);
	double theta = Rcpp::as<double>(arg7);

	return wrap(mycontour.getContourPt(theta));
