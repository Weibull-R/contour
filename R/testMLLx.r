testMLLx<-function(x,  dist="weibull", CL=0.9,DF=1,MLEfit=NULL, RadLimit=1e-5)  {
...
## Test for successful construction of objects by comparing identical LL calculations
	testValue <- .Call("testMLLx", MLEclassList, par_hat, dist_num, MLLx, ratioLL, RadLimit, package="contour")
